    ...
    describe "match" $ do
        it "should match if there is exact match of game title in games" $ do
            let ec = EntryCondition (Just ["Game - title"]) Nothing
                ge = GiveawayEntry "" "Game - title" 0 0
